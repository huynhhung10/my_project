 ...
 */
final class Version20240407045929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reviews (id INT AUTO_INCREMENT NOT NULL, movie_id INT DEFAULT NULL, customer_id INT DEFAULT NULL, review_text VARCHAR(255) NOT NULL, rating INT NOT NULL, INDEX IDX_6970EB0F8F93B6FC (movie_id), INDEX IDX_6970EB0FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reviews ADD CONSTRAINT FK_6970EB0FA76ED395 FOREIGN KEY (customer_id) REFERENCES customers (id)');
    }
