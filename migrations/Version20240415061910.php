 ...
 */
final class Version20240415061910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customers (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, img LONGTEXT NOT NULL, email VARCHAR(255) NOT NULL, phonenumber VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE movies (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, decription LONGTEXT NOT NULL, createat DATETIME NOT NULL, img LONGTEXT NOT NULL, INDEX IDX_C61EED304296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reviews (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, movie_id INT DEFAULT NULL, reviewtext LONGTEXT NOT NULL, rating INT NOT NULL, INDEX IDX_6970EB0F9395C3F3 (customer_id), INDEX IDX_6970EB0F8F93B6FC (movie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
